...
$\int^\infty_0x^{\alpha-1}e^{-x}dx/\Gamma(\alpha)$
...
$S(x) = 1 - \int^x_0x^{\alpha-1}e^{-x}dx/\Gamma(\alpha)$

$S(x) = 1 - \Gamma(\alpha, x)/\Gamma(\alpha)$
...
$\int^\infty_0x^{\alpha-1}e^{-x/\beta}dx/\beta^\alpha\Gamma(\alpha)$
...
$\int^\infty_0u^{\alpha-1}e^{-u}du/\Gamma(\alpha)$
...
$\int^\infty_0\gamma x^{\gamma-1}e^{-x^\gamma/\beta}/\beta = 1$
...
$du = \gamma x^{\gamma - 1}/\beta dx$

and we notice that

$du\beta/\gamma = x^{\gamma-1}dx$

we can write the original equation as

$\int^\infty_0 e^{-u}du = -e^{-u}|^\infty_0 = 0--1 = 1$
...
$F^{-1}(x) = log(-\beta log(1-x))/\gamma$

The median is such that

$F^{-1}(0.5) = log(-\beta log(1-0.5))/\gamma = log(-\beta log(.5))/\gamma$
...
$1/(B(\alpha, \beta))\int^1_0x^{\alpha-1}(1-x)^{\beta-1}$

$B(\alpha, \beta)/B(\alpha, \beta) = 1$
...
$B(1,1)=\Gamma(1)\Gamma(1)/\Gamma(2) = 0!0!/1! = 1$
